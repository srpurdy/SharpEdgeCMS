...
|
*/
$config['encryption_key'] = "Sd94jbvSDFdkl389vdfjds82Adfhj4";
...
if (isset($_SERVER["REQUEST_URI"])) 
	...
	if(stripos($_SERVER["REQUEST_URI"],'/ckfinder_ci') === FALSE)
		{
		$config['csrf_protection'] = TRUE;
		}
	else
...
$config['csrf_token_name'] = 'csrf_sharpedgeV320';
$config['csrf_cookie_name'] = 'csrfsharpedge';
