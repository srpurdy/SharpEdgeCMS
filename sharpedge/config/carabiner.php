...
$config['carabiner']['script_dir'] = 'assets/static/javascript/';
$config['carabiner']['style_dir'] = 'assets/static/css/';
$config['carabiner']['cache_dir'] = 'framework_2_0_3/cache/';
$config['carabiner']['minify_js'] = FALSE;
$config['carabiner']['minify_css'] = FALSE;
...
$config['carabiner']['groups']['jquery'] = array(
...
$config['carabiner']['groups']['jqueryui'] = array(
...
$config['carabiner']['groups']['prototype'] = array(
...
/*
$config['carabiner']['groups']['scriptaculous'] = array(
...
// MooTools
$config['carabiner']['groups']['mootools'] = array(
...
$config['carabiner']['groups']['dojo'] = array(
...
$config['carabiner']['groups']['swfobject'] = array(
...
$config['carabiner']['groups']['yui'] = array(
