...
<?php else:?>
<div class="profile_widget remove_underline">
<?php foreach($current_profile as $cp):?>
<div class="profile_widget_info">
<div class="profile_info_image">
<img src="<?php echo base_url();?><?php echo $this->config->item('ava_upload_directory');?>/<?php echo $cp->avatar?>" alt="Current Image" />
</div>
