...
<!-- MAIN Template CSS -->
<link rel="stylesheet" href="<?php echo base_url();?>themes/<?php echo $mobile_theme?>/css/mobile_default.css" media="screen" type="text/css" />
...
<!--[if lt IE 9]>
<link rel="stylesheet" href="<?php echo base_url();?>themes/<?php echo $theme?>/css/ie.css" type="text/css" />
<![endif]-->
