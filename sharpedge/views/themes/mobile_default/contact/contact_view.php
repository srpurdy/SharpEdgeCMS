<?php echo form_open('contact');?>
	<fieldset>
			...
			<label class="control-label"><?php echo $gf->name?> <?php if($gf->is_required == 'Y'):?><img src="<?php echo base_url();?>assets/images/system_images/tick.gif" alt="" /><?php endif;?></label>
				<div class="controls">
				<input type="text" class="span2" name="<?php echo url_title($gf->name)?>" value="" />
				</div>
			</div>
			...
			<label class="control-label"><?php echo $gf->name?> <?php if($gf->is_required == 'Y'):?><img src="<?php echo base_url();?>assets/images/system_images/tick.gif" alt="" /><?php endif;?></label>
				<div class="controls">
				<textarea class="span2" name="<?php echo url_title($gf->name)?>" rows="10" cols="25"></textarea>
				</div>
			</div>
			...
			<label class="control-label"><?php echo $gf->name?> <?php if($gf->is_required == 'Y'):?><img src="<?php echo base_url();?>assets/images/system_images/tick.gif" alt="" /><?php endif;?></label>
				<div class="controls">
				<textarea class="span4" name="<?php echo url_title($gf->name)?>" rows="15" cols="70"></textarea>
				</div>
			</div>
