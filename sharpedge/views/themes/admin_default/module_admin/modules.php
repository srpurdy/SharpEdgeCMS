...
$('#tab2').live('click', function()
{
	...
	<div class="tab-content">
		<div class="tab-pane active" id="tabs-1">
			...
			<td>
			<a class="btn" href="<?php echo site_url();?>/module_admin/edit_module/<?php echo $row->id?>"><i class="icon-pencil"></i> <?php echo $this->lang->line('label_edit');?></a>
			<a class="btn btn-danger" href="<?php echo site_url();?>/module_admin/delete_module/<?php echo $row->id?>" onClick="return confirm('Are you sure you want to Delete this item?')"><i class="icon-trash icon-white"></i> <?php echo $this->lang->line('label_delete');?></a>
			</td>
			</tr>
			<?php endforeach;?>
			</tbody>
		...
		<?//php echo modules::run('module_admin/add_module');?>
		</div>
	</div>