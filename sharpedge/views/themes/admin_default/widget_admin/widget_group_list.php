...
$('#tab2').live('click', function()
{
	...
	<div class="tab-content">
		<div class="tab-pane active" id="tabs-1">
			...
			<td>
			<a class="btn" href="<?php echo site_url()?>/widget_admin/edit_to_group/<?php echo $row->gm_id?>/<?php echo $this->uri->segment(3);?>"><i class="icon-pencil"></i> <?php echo $this->lang->line('label_edit');?></a>
			<a class="btn btn-danger" href="<?php echo site_url()?>/widget_admin/delete_to_group/<?php echo $row->gm_id?>/<?php echo $this->uri->segment(3);?>" onClick="return confirm('Are you sure you want to Delete this item?')"><i class="icon-trash icon-white"></i> <?php echo $this->lang->line('label_delete');?></a>
			</td>
			</tr>
			<?php endforeach;?>
			</tbody>
