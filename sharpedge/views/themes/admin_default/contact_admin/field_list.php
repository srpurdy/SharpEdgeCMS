...
$('#tab4').live('click', function()
{
	...
	<div class="tab-content">		
		<div class="tab-pane active" id="tabs-1">
			...
			<td>
			<a class="btn" href="<?php echo site_url();?>/contact_admin/edit_field/<?php echo $id->id?>"><i class="icon-pencil"></i> <?php echo $this->lang->line('label_edit');?></a>
			<a class="btn btn-danger" href="<?php echo site_url();?>/contact_admin/delete_field/<?php echo $id->id?>" onClick="return confirm('Are you sure you want to Delete this item? You cannot restore it once it is deleted......')"><i class="icon-trash icon-white"></i> <?php echo $this->lang->line('label_delete');?></a>
			</td>
			</tr>
			<?php endforeach; ?>
			</tbody>
