...
<?php foreach($query->result() as $id):?>
					<tr>
						...
						<td>
						<a class="btn btn-default" href="<?php echo site_url();?>/download_admin/edit_download/<?php echo $id->download_id?>"><span class="glyphicon glyphicon-pencil"></span> <?php echo $this->lang->line('label_edit');?></a>
						<a class="btn btn-danger" href="<?php echo site_url();?>/download_admin/delete_download/<?php echo $id->download_id?>" onClick="return confirm('Are you sure you want to Delete this item? You cannot restore it once it is deleted......')"><span class="glyphicon glyphicon-trash"></span> <?php echo $this->lang->line('label_delete');?></a>
						</td>
					</tr>
<?php endforeach; ?>
				</tbody>
