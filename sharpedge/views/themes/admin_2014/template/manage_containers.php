...
$('#tab2').live('click', function()
{
	...
	<div class="tab-content">		
		<div class="tab-pane active" id="tabs-1">
			...
			<td>
			<a class="btn btn-default" href="<?php echo site_url()?>/template/editcontainer/<?php echo $row->c_id?>"><span class="glyphicon glyphicon-pencil"></span> <?php echo $this->lang->line('label_edit');?></a>
			<a class="btn btn-danger" href="<?php echo site_url()?>/template/deletecontainer/<?php echo $row->c_id?>" onClick="return confirm('Are you sure you want to Delete this item?')"><span class="glyphicon glyphicon-trash"></span> <?php echo $this->lang->line('label_delete');?></a>
			</td>
			</tr>
			<?php endforeach;?>
			</tbody>
