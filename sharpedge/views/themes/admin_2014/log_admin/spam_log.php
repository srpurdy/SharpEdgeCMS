	...
	<div class="tab-content">		
		...
		<a class="btn btn-danger" href="<?php echo site_url();?>/log_admin/delete_spam_log" onClick="return confirm('Are you sure you want to Delete this item?')"><span class="glyphicon glyphicon-trash"></span>  <?php echo $this->lang->line('label_clear_log');?></a>
