...
class Ion_auth_model extends CI_Model
{
	...
	public function login($identity, $password, $remember=FALSE)
	{
	    ...
	    $query = $this->db->select('users.username, users.email, users.id, users.password, users.last_login, users.first_name, users.last_name, groups.name')
