...
$lang['db_must_use_index'] = 'Трябва да посочите индекс на мач за партида актуализации.';
$lang['db_batch_missing_index'] = 'Един или повече редове, представени за актуализиране на партидите липсва определен индекс.';
$lang['db_must_use_where'] = 'Актуализации не са позволени, освен ако не съдържат ", където" клауза.';
...
$lang['db_filepath_error'] = 'Не може да пишете данни за пътя на файла, които сте подали.';
